...
import MainStepIndicator from "@/components/MainStepIndicator";
...
const navItems: NavItem[] = [
  ...
  { name: "Campaigns", icon: Layers, href: "/lead-nurture-tool/dashboard/batches" },
      ...
      <div className="relative z-10">
              ...
              return (
                <Link key={item.href} href={item.href}>
                  <motion.div
                    ...
                    className={`relative flex items-center gap-3 px-3 py-3 rounded-lg transition-all group cursor-pointer ${active
        ...
        <div className="lg:ml-20">
          ...
          <div className="pt-20 lg:pt-6 p-6">
            <MainStepIndicator completedSteps={completedSteps} isLoading={isLoadingSteps} />
            {children}
          </div>
        </div>
      </div>
